    ...
    <div>
      <nav className="bg-white border-gray-200 dark:bg-black shadow-md dark:shadow-[#222]">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          <Link
            to={"/"}
            className="flex flex-col justify-center items-center space-x-3 rtl:space-x-reverse"
          >
            <div className="flex flex-row gap-1">
              <h1 className="text-3xl text-center bg-red-500 text-white p-1">
                B
              </h1>
              <h1 className="text-3xl text-center bg-red-500 text-white p-1">
                B
              </h1>
              <h1 className="text-3xl text-center bg-yellow-500 text-white p-1">
                C
              </h1>
            </div>

            <h1 className="text-3xl text-start font-bold ">News</h1>
          </Link>
          {isAuthenticated ? (
            <div className="md:order-2 flex max-lg:gap-5 items-center">
              ...
              />
              <Link
                className="rounded-full max-lg:hidden hover:bg-black dark:hover:bg-white create-article dark:hover:text-black dark:text-white hover:text-white transition-all flex items-center dark:border-white border-black gap-3 p-0.5 pe-5 border"
                to={"/create-article"}
              >
            ...
            <div className="flex font-bold items-center text-sm gap-2 md:order-2">
              ...
              />
              <Link
                className="border border-black px-6 transition-all hover:bg-black hover:text-white py-2.5 rounded"
                to={"/signup"}
              >
                Sign Up
              </Link>
              <Link
                className="text-white bg-black px-8 hover:text-black border border-black transition-all hover:bg-transparent py-2.5 rounded"
                to={"/login"}
              >
                Login
              </Link>
